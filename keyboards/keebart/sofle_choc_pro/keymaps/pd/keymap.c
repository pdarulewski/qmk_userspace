...
*/
    [QWE] = LAYOUT_split_4x6_5(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    C(KC_A),      KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
...
*/
    [COL] = LAYOUT_split_4x6_5(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_BSPC,      KC_BSPC, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          KC_LGUI, KC_LALT, KC_LCTL, MO(SYM), KC_ENT,       KC_SPC,  MO(FUN), KC_RCTL, KC_RALT, KC_RGUI
    ),
/*
          ~ s y m b o l s ~                            ┆
...
*/
    [FUN] = LAYOUT_split_4x6_5(
        ...
        DF(QWE), DF(COL), _______, _______, _______, _______, KC_MUTE,      KC_MPLY, _______, _______, _______, _______, _______, _______,
                          QK_BOOT,QK_REBOOT,_______, _______, KC_ENT,       KC_SPC,  _______, _______, _______,_______
    ),
};
